...
def tag_ticket(subcategory, subject):
    ...
    return 'IPRS - General Issue'

def generate_iprs_pdf(save_dir, csv_path):
    ...
    plt.title('IPRS Ticket Tag Distribution')
    pie_chart_path = f"{save_dir}/iprs_pie_chart.png"
    ...
    pdf_path = f"{save_dir}/iprs_report.pdf"
    doc = SimpleDocTemplate(pdf_path, pagesize=A4)
    styles = getSampleStyleSheet()
    elements = [
        Paragraph("IPRS Ticket Tag Report", styles['Title']),
        Spacer(1, 12),
